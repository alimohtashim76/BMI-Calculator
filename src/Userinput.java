...
public class Userinput {
    ...
    public static String obtainBMISystem() {
    ...
    public static double obtainWeight(String bmiSystem) {
    ...
    public static double obtainHeight(String bmiSystem) {
        ...
        while(isInputValid){
            ...
            switch(bmiSystem){
                ...
                case  "":
                    System.out.println("Enter a valid system");
                    break;
